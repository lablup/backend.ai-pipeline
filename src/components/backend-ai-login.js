...
/**
 Backend.AI Login for Console and Pipeline projects
 ...
 @group Backend.AI Console, Backend.AI Pipeline
 */
class BackendAiLogin extends LitElement {
  ...
  login() {
    this.api_key = JSON.parse(localStorage.getItem('backendaipipeline.api_key'));
    this.secret_key = JSON.parse(localStorage.getItem('backendaipipeline.secret_key'));
    this.user_id = JSON.parse(localStorage.getItem('backendaipipeline.user_id'));
    this.password = JSON.parse(localStorage.getItem('backendaipipeline.password'));
    ...
    if (this.api_endpoint === '') {
      this.api_endpoint = JSON.parse(localStorage.getItem('backendaipipeline.api_endpoint'));
    }
  ...
  render() {
    // language=HTML
    return html`
      <app-localstorage-document key="backendaipipeline.email" data="{{email}}"></app-localstorage-document>
      <app-localstorage-document id="storage" key="backendaipipeline.api_key"
                                 data="${this.api_key}"></app-localstorage-document>
      <app-localstorage-document key="backendaipipeline.secret_key" data="${this.secret_key}"></app-localstorage-document>
      <app-localstorage-document id="storage" key="backendaipipeline.user_id"
                                 data="${this.user_id}"></app-localstorage-document>
      <app-localstorage-document key="backendaipipeline.password" data="${this.password}"></app-localstorage-document>
      <app-localstorage-document key="backendaipipeline.api_endpoint"
